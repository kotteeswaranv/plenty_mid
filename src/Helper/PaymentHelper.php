...
namespace Novalnetpayment\Helper;
 ...
 * Class PaymentHelper
 *
 * @package Novalnetpayment\Helper
 */
class PaymentHelper
{
    use Loggable;
    ...
    */
    ...
    public function assignPlentyPaymentToPlentyOrder(Payment $payment, int $orderId)
    {
        ...
        $authHelper->processUnguarded(
            ...
            $this->getLogger(__METHOD__)->error('Novalnetpayment::assignPlentyPaymentToPlentyOrder', $e);
        }
    }
    ...
    public function updateOrderStatus($orderId, $statusId)
    {
        try {
            ...
            $this->getLogger(__METHOD__)->error('Novalnetpayment::updateOrderStatus', $e);
        }
    }
    ...
    public function createOrderComments($orderId, $text)
    {
        try {
            ...
            $this->getLogger(__METHOD__)->error('Novalnetpayment::createOrderComments', $e);
        }
    }
    ...
    */
    public function getTranslatedText($key)
    {
        ...
        return $translator->trans("Novalnetpayment::PaymentMethod.$key");
    }
