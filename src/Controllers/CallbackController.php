...
namespace Novalnetpayment\Controllers;
...
use Novalnetpayment\Services\TransactionService;
 ...
 *
 * @package Novalnetpayment\Controllers
 */
class CallbackController extends Controller
{
    ...
    public function sendCallbackMail($mailContent)
    {
        try
        {
            ...
            $this->getLogger(__METHOD__)->error('Novalnetpayment::CallbackMailNotSend', $e);
            return false;
        }
    }
    ...
    {
        return $this->twig->render('Novalnetpayment::callback.callback', ['comments' => $templateData]);
    }
}
