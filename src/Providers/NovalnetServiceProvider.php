...
use Novalnetpayment\Methods\NovalnetPaymentMethod;
use Novalnetpayment\Services\PaymentService;
        ...
        $eventDispatcher->listen(GetPaymentMethodContent::class,
                function(GetPaymentMethodContent $event) use($paymentHelper, $paymentService, $basketRepository, $paymentMethodService, $sessionStorage, $twig)
                {
                    if($event->getMop() == $paymentHelper->getPaymentMethod())
                    {
                        ...
                        $content = $twig->render('Novalnetpayment::NovalnetPaymentRedirectForm', [
